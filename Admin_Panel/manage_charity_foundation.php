...
<!-- Charity Foundation Table Data Load -->
 <?php
...
<html class="fixed">
	<head>
		...
		<title>Admin Panel  - Manage Charity Foundation</title>
			...
			<div class="inner-wrapper">
								...
								<ul class="nav nav-main">
									...
									<li>
										<a href="manage_doner_appointment.php">
											...
											<span>View Blood Doner Appointment</span>
										</a>
									</li>
									<li>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Manage Charity Foundation</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Manage Charity Foundation</span></li>
							</ol>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Charity Foundation List</h2>
									</header>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											<thead>
												<tr>
													...
													<th>Foundation Contact No.</th>
													<th>Foundation E-mail</th>
													<th>Foundation Opening Hour</th>
													<th>About Foundation</th>
													<th>Foundation Owner Name</th>
													<th>Foundation Owner Contact No.</th>
													<th>Verify Status</th>
													<th>Verify Charity Foundation</th>
													<th>Action</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													<td class="text-primary" style="font-weight: bold;"><?php echo "Foundation Id-".$result['foundation_id']; ?></td>
													<td><img src="<?php echo '../Service_Panel/'.$result['foundation_image'] ?>" height="90" alt="charity_foundation_img"></td>
													<td style="font-weight: bold;"><?php echo $result['charity_foundation_name']; ?></td>
													<td><?php echo $result['foundation_address']; ?></td>
													<td><?php echo $result['contact_number']; ?></td>
													<td><?php echo $result['email']; ?></td>
													<td><?php echo $result['foundation_opening_hour']; ?></td>
													<td><input type="text" name="about_foundation" value="<?php echo $result['about_foundation']; ?>"></td>
													<td><?php echo $result['foundation_owner_name']; ?></td>
													<td><?php echo $result['owner_contact_number']; ?></td>
													<td>
						                                <?php
						                            ...
						                            <td>
					                                  <?php
					                                     ...
					                                     {
					                                       ?>
					                                         	<button type="button" class="btn btn-success btn-rounded btn-sm" name="button" disabled><i class="fa fa-check"></i> Verified</button>
					                                        <?php
					                                      }
					                                      else
					                                      {
					                                        ?>
					                                        	<a href="charity_foundation_verification.php?foundation_id=<?php echo $result['foundation_id']; ?>" onclick="return confirm('Sure to verify charity foundation?')" class="btn btn-success btn-rounded btn-sm" > Verify Foundation</a>
					                                        <?php
					                                      }
					                                   ?>
					                               </td>
													<td><a onclick="return confirm('Sure to delete?')" href="delete_data.php?foundation_id=<?php echo $result['foundation_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
						                          <?php }else{ ?>
