...
<html class="fixed">
	<head>
		...
		<title>Admin Panel  - Blood Donation Center</title>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="<?php echo '../Service_Panel/'.$result['donation_center_image'] ?>" height="90" alt="blood_donation_center"></td>
						                            ...
						                            <td>
					                                  <?php
					                                     ...
					                                     if($is_verified == 1)
					                                     {
					                                      ...
					                                      {
					                                        ?>
					                                        	<a href="blood_donation_center_activation.php?blood_donation_center_id=<?php echo $result['blood_donation_center_id']; ?>" onclick="return confirm('Sure to active blood donation center?')" class="btn btn-success btn-rounded btn-sm" >Active Now</a>
					                                        <?php
					                                      }
					                                   ?>
					                               </td>

													<td><a onclick="return confirm('Sure to delete?')" href="delete_data.php?blood_donation_center_id=<?php echo $result['blood_donation_center_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
						                          <?php }else{ ?>
