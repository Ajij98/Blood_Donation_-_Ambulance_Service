...
<html class="fixed">
	<head>
		...
		<title>Admin Panel  - Blood Doner</title>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="<?php echo '../Service_Panel/'.$result['doner_image'] ?>" height="90" style="border: 3px solid #0088CC;" alt="blood_doner"></td>
													...
													<td><a onclick="return confirm('Sure to delete?')" href="delete_data.php?blood_doner_id=<?php echo $result['blood_doner_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
						                          <?php }else{ ?>
