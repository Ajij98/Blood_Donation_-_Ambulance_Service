...
<head>
  ...
  <title>Blood Donation and Ambulance Service - Blood Donation</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-9 mt-4 mt-lg-0" style="border-left: 1px solid">
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">Sign Up first to donate blood</p>
                    
                    <p><i class="fa fa-hand-o-right" style="color: #2C4964;" aria-hidden="true"></i> Click on register to donate button.</p>
                    <p><i class="fa fa-hand-o-right" style="color: #2C4964;" aria-hidden="true"></i> Fill-Up the registration form (please fill-up all the required field**).</p>
                    <p><i class="fa fa-hand-o-right" style="color: #2C4964;" aria-hidden="true"></i> Donate blood by your self or donate in any blood donation center.</p>
              ...
              <a href="registration.php" class="appointment-btn scrollto mt-4"><span class="d-none d-md-inline">Register to Donate by Your Self</span></a>

              <a href="registration.php" class="appointment-btn scrollto mt-4"><span class="d-none d-md-inline">Register to Donate in Blood Donation Center</span></a>
