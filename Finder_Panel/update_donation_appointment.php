...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      ...
      <div class="d-none d-lg-flex social-links align-items-center">
        <a href="#" class="twitter">| About Us |</a> <a href="contacts.php">| Contacts |</a> <a href="login.php">| Login |</a>
      </div>
    </div>
  </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#">DONATE MONEY</a></li>
          <li><a class="nav-link scrollto" href="#services">SERVICES</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->

      <a href="login.php" class="appointment-btn scrollto" style="background-color: #EE3D32;"><span class="d-none d-md-inline">My Donation</span></a>
  ...
  <section id="hero" class="d-flex align-items-center" style="background: url('assets/img/bg-5.jpg') top center;">
    <div class="container">
      <h1 style="color: white;">Reschedule Appointment</h1>
      <h2 style="color: white;">Patients need your help.</h2>
      <a href="#appointment" class="btn-get-started scrollto" style="background-color: #EE3D32;">Reschedule Appointment Now</a>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="col-8 m-auto shadow px-4 py-4" style="border-radius: 5px;">
          ...
          <div class="text-center mt-3"><button type="submit">Update Now</button></div>
        </form>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Donate Blood</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Find Blood Doner</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Ambulance Service</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Donate Money</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Ambulance Service</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Support People</a></li>
            </ul>
          </div>
