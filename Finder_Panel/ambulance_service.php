<?php
 ...
 <!-- Ambulance Service Card Data Load -->
 <?php
   $user_name       = $_SESSION['user_name'];
   $db              = new Database();
   $sql             = "SELECT * FROM tb_ambulance_service WHERE is_verified = 1";
...
<head>
  ...
  <title>Blood Donation and Ambulance Service - Ambulance Service</title>
...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center" style="background: url('assets/img/ambulance_service-3.jpg') top center;">
    <div class="container">
      <h1 style="color: white;">Ambulance Service</h1>
      <h2 style="color: white;">We are 24/7 ready to help you.</h2>
      <a href="#appointment" class="btn-get-started scrollto" style="background-color: #EE3D32;">Take Service</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="appointment" class="appointment section-bg">
        ...
        <div class="section-title">
          ...
          <img src="assets/icons/ambulance (1).png" width="50" height="50">
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 col-md-6 col-12 mb-3 ml-2">
            <div class="card shadow" style="width: 18rem;">
              <img src="<?php echo '../Service_Panel/'.$result['serivice_image'] ?>" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title mb-3"><img src="assets/icons/ambulance (1).png" width="30" height="30"> <b><?php echo $result['ambulance_service_name']; ?></b></h5>
                
                <p class="card-text mb-1"><i class="fa fa-map-marker" style="color: #196CB3;" aria-hidden="true"></i> <?php echo $result['service_address']; ?></p>
                <p class="card-text mb-1"><i class="fa fa-phone" style="color: #196CB3;" aria-hidden="true"></i> <?php echo $result['service_contact']; ?></p>
                <p class="card-text"><i class="fa fa-calendar" style="color: #196CB3;" aria-hidden="true"></i> <?php echo $result['service_opening_time']; ?></p>

                <a href="ambulance_service_details.php?ambulance_service_id=<?php echo $result['ambulance_service_id']; ?>" class="btn btn-outline-danger px-4 py-2 my-2" style="border-radius: 20px; font-size: 14px;"><span class="d-none d-md-inline">View Details</span></a>
              </div>
            </div>
          </div>
          <?php } ?>
