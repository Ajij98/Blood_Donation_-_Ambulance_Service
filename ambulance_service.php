...
<body>
  ...
  <section id="hero" class="d-flex align-items-center" style="background: url('assets/img/ambulance_service-3.jpg') top center;">
    <div class="container">
      ...
      <a href="login.php" class="btn-get-started scrollto" style="background-color: #EE3D32;">Take Service</a>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="appointment" class="appointment section-bg">
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h5 class="text-danger">**Login as a "General User" to "TAKE AMBULANCE SERVICE", if you don't have any account to login, create a new account.**</h5>

            <a href="login.php" class="appointment-btn scrollto mt-4"><span class="d-none d-md-inline">Login Now</span></a>
            <a href="registration.php" class="appointment-btn scrollto mt-4"><span class="d-none d-md-inline">Create a New Account</span></a>
