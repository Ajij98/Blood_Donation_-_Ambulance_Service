...
<!--Update Ambulance Service Details -->
  <?php
    error_reporting( error_reporting() & ~E_NOTICE );
    $db = new Database();
    $current_datetime = date("Y-m-d") . ' ' . date("H:i:s", STRTOTIME(date('h:i:sa')));
   ...
   if(isset($_POST['update']))
   {
         ...
         if($serivice_image != "")
         {
           ...
           $sql = "UPDATE tb_ambulance_service SET ambulance_service_name='$ambulance_service_name',about_service='$about_service',serivice_image='$dst_db',service_address='$service_address',service_contact='$service_contact',service_opening_time='$service_opening_time',service_owner_name='$service_owner_name',owner_contact='$owner_contact' WHERE ambulance_service_id = $ambulance_service_id";

           $update_row = $db->update($sql);
         }

           $sql = "UPDATE tb_ambulance_service SET ambulance_service_name='$ambulance_service_name',about_service='$about_service',service_address='$service_address',service_contact='$service_contact',service_opening_time='$service_opening_time',service_owner_name='$service_owner_name',owner_contact='$owner_contact' WHERE ambulance_service_id = $ambulance_service_id";
         ...
         <script type="text/javascript">
           ...
           window.alert("Ambulance Service details updated successfully.");
...
<html class="fixed">
	<head>
		...
		<title>Service Panel  - Update Ambulance Service</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Update Ambulance Service</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Update Ambulance Service</span></li>
							</ol>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Update Service Details</h2>
									</header>
									<div class="panel-body">
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">							
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="ambulance_service_name" placeholder="Enter ambulance service name" value="<?php echo $ambulance_service_name; ?>" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="about_service" placeholder="About your service" required><?php echo $about_service; ?></textarea>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<img src="<?php echo $serivice_image; ?>" height="130" alt="ambulance_service_img">
														<br><br>
														<input type="file" class="form-control" name="serivice_image">
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="service_address" placeholder="Enter service address" value="<?php echo $service_address; ?>" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="service_contact" placeholder="Enter service contact number" value="<?php echo $service_contact; ?>" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="service_opening_time" placeholder="Enter service open hour" value="<?php echo $service_opening_time; ?>" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="service_owner_name" placeholder="Enter service owner name" value="<?php echo $service_owner_name; ?>" required>
													</div>
											</div>
