<?php
 ...
 <?php
   ...
   $db              = new Database();
   $sql             = "SELECT * FROM tb_charity_foundation WHERE added_by = '$user_name'";
...
<html class="fixed">
	<head>
		...
		<title>Service Panel  - Manage Charity Foundation</title>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="<?php echo $result['foundation_image'] ?>" height="90" alt="charity_foundation_img"></td>
													...
													<td><a href="update_foundation_details.php?foundation_id=<?php echo $result['foundation_id']; ?>" title="update" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a> <a onclick="return confirm('Sure to delete?')" href="delete_data.php?foundation_id=<?php echo $result['foundation_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
						                          <?php }else{ ?>
