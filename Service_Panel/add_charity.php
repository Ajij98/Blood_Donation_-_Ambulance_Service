<?php
 ...
 <?php
   ...
   {	
         ...
         $sql = "INSERT INTO tb_charity_foundation(foundation_code,charity_foundation_name,foundation_image,about_foundation,foundation_address,contact_number,email,foundation_opening_hour,organization_type,social_media_link,foundation_owner_name,owner_email,owner_contact_number,owner_nid_number,way_of_payment,added_by,entry_time)values('$foundation_code','$charity_foundation_name','$dst_db','$about_foundation','$foundation_address','$contact_number','$email','$foundation_opening_hour','$organization_type','$social_media_link','$foundation_owner_name','$owner_email','$owner_contact_number','$owner_nid_number','$way_of_payment','$added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             ...
             window.location='add_charity.php';
           </script>
...
<html class="fixed">
	<head>
		...
		<title>Service Panel  - Add Charity Foundation</title>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Add Charity Foundation</span></li>
							</ol>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add Charity Foundation</h2>
									</header>
									<div class="panel-body">
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data" autocomplete="off">							
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="charity_foundation_name" placeholder="Enter charity foundation name" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="file" class="form-control" name="charity_foundation_img" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" rows="4" name="about_foundation" placeholder="About charity foundation" required></textarea>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="foundation_address" placeholder="Enter foundation address" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="contact_number" placeholder="Enter foundation contact number" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="email" placeholder="Enter foundation email" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="foundation_opening_hour" placeholder="Enter foundation opening hour" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="organization_type" placeholder="Enter organization type" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="social_media_link" placeholder="Enter social media link, if any" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="foundation_owner_name" placeholder="Enter foundation owner name" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="owner_email" placeholder="Enter owner email" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="owner_contact_number" placeholder="Enter owner contact number" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control" name="owner_nid_number" placeholder="Enter owner nid number" required>
													</div>
											</div>
											...
											<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" name="way_of_payment" id="way_of_payment" required></textarea>
													</div>
											</div>
											...
											<div class="form-group">
													<div class="col-md-12 text-center">
    													...
    													<label class="form-check-label text-danger" for="exampleCheck1">I can show all evidence about foundation in any situation.</label>
													</div>
											</div>

											<div class="form-group">
													<div class="col-md-12 text-center">
														<input  type="submit" class="btn btn-primary" style="padding-left: 20px; padding-right: 20px;" name="submit" value="Add Foundation">
													</div>
											</div>
