<?php
 ...
 <?php
   ...
   $db              = new Database();
   $sql             = "SELECT * FROM tb_ambulance_service WHERE added_by = '$user_name'";
...
<html class="fixed">
	<head>
		...
		<title>Service Panel  - Manage Ambulance Service</title>
										...
										<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="<?php echo $result['serivice_image'] ?>" height="90" alt="ambulance_service_image"></td>
													...
													<td><a href="#" class="btn btn-success btn-rounded btn-sm" >Make Payment</a></td>

													<td><a href="update_ambulance_service_details.php?ambulance_service_id=<?php echo $result['ambulance_service_id']; ?>" title="update" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a> <a onclick="return confirm('Sure to delete?')" href="delete_data.php?ambulance_service_id=<?php echo $result['ambulance_service_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php } ?>
						                          <?php }else{ ?>
